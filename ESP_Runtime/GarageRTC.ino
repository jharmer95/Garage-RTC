...
void TaskNetwork(void* pvParameters)
{
  ...
  while (true)
  {
    ...
    if (connected)
    {
      ...
      sprintf(wifiBuff, "[{\"name\": \"alarmStatus\", \"value\": \"%s\"}, {\"name\": \"doorStatus\", \"value\": \"%d\"}, {\"name\": \"lightStatus\", \"value\": \"%s\"}, {\"name\": \"tempStatus\", \"value\": \"%s\"}, {\"name\": \"coStatus\", \"value\": \"%s\"}]", alarmState ? "True" : "False", doorPosition, lightOnState ? "ON" : "OFF", tempBuff, g_coStateStr[coState]);
